...
Route::group(['middleware'=>'teacher'],function (){
    ...
    Route::get('/course_delete/{id}',[CourseController::class,'course_delete'])->name('course_delete');
    Route::get('/manage-course-edit/{id}',[CourseController::class,'manageCourseEdit'])->name('manage_course_edit');
    ...
    Route::get('/delete_applicant/{id}',[CourseController::class,'deleteApplicant'])->name('delete_applicant');
});
